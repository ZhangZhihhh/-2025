...
0000000000800020 <__panic>:
  ...
  800054:	7d050513          	addi	a0,a0,2000 # 800820 <main+0x174>
...
0000000000800062 <__warn>:
  ...
  800096:	78e50513          	addi	a0,a0,1934 # 800820 <main+0x174>
...
0000000000800126 <cputch>:
  ...
  80012e:	fc7ff0ef          	jal	ra,8000f4 <sys_putc>
...
0000000000800140 <vcprintf>:
  ...
  800152:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <magic+0xffffffffff7f5ad9>
  800156:	ec06                	sd	ra,24(sp)
  800158:	c602                	sw	zero,12(sp)
  80015a:	1b4000ef          	jal	ra,80030e <vprintfmt>
...
0000000000800166 <cprintf>:
  ...
  800186:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <magic+0xffffffffff7f5ad9>
  ...
  800196:	178000ef          	jal	ra,80030e <vprintfmt>
...
00000000008001e6 <umain>:
  ...
  8001f6:	60e58593          	addi	a1,a1,1550 # 800800 <main+0x154>
  8001fa:	4501                	li	a0,0
...
000000000080025a <exit>:
  ...
  800266:	60650513          	addi	a0,a0,1542 # 800868 <main+0x1bc>
...
0000000000800272 <wait>:
  800272:	4581                	li	a1,0
  800274:	4501                	li	a0,0
  800276:	bd8d                	j	8000e8 <sys_wait>
...
00000000008006ac <main>:
  ...
  8006ba:	aadff0ef          	jal	ra,800166 <cprintf>
  8006be:	bb3ff0ef          	jal	ra,800270 <fork>
  ...
  8006d0:	a97ff0ef          	jal	ra,800166 <cprintf>
  ...
  8006e0:	a87ff0ef          	jal	ra,800166 <cprintf>
  8006e4:	006c                	addi	a1,sp,12
  8006e6:	8522                	mv	a0,s0
  8006e8:	b91ff0ef          	jal	ra,800278 <waitpid>
  ...
  800700:	b79ff0ef          	jal	ra,800278 <waitpid>
  800704:	c529                	beqz	a0,80074e <main+0xa2>
  800706:	b6dff0ef          	jal	ra,800272 <wait>
  ...
  800792:	9d5ff0ef          	jal	ra,800166 <cprintf>
  800796:	ae5ff0ef          	jal	ra,80027a <yield>
  80079a:	ae1ff0ef          	jal	ra,80027a <yield>
  80079e:	addff0ef          	jal	ra,80027a <yield>
  8007a2:	ad9ff0ef          	jal	ra,80027a <yield>
  8007a6:	ad5ff0ef          	jal	ra,80027a <yield>
  8007aa:	ad1ff0ef          	jal	ra,80027a <yield>
  8007ae:	acdff0ef          	jal	ra,80027a <yield>
  8007b2:	00001517          	auipc	a0,0x1
  8007b6:	84e52503          	lw	a0,-1970(a0) # 801000 <magic>
  8007ba:	aa1ff0ef          	jal	ra,80025a <exit>

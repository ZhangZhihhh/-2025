...
0000000000800020 <__panic>:
  ...
  800054:	90050513          	addi	a0,a0,-1792 # 800950 <main+0x126>
...
0000000000800062 <__warn>:
  ...
  800096:	8be50513          	addi	a0,a0,-1858 # 800950 <main+0x126>
...
000000000080014a <vcprintf>:
  ...
  80015c:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <matc+0xffffffffff7f57b1>
  800160:	ec06                	sd	ra,24(sp)
  800162:	c602                	sw	zero,12(sp)
  800164:	1c8000ef          	jal	ra,80032c <vprintfmt>
...
0000000000800170 <cprintf>:
  ...
  800190:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <matc+0xffffffffff7f57b1>
  ...
  8001a0:	18c000ef          	jal	ra,80032c <vprintfmt>
...
00000000008001f0 <umain>:
  ...
  800200:	73458593          	addi	a1,a1,1844 # 800930 <main+0x106>
  800204:	4501                	li	a0,0
...
0000000000800264 <exit>:
  ...
  800270:	72c50513          	addi	a0,a0,1836 # 800998 <main+0x16e>
...
000000000080027c <wait>:
  80027c:	4581                	li	a1,0
  80027e:	4501                	li	a0,0
  800280:	b5a5                	j	8000e8 <sys_wait>

0000000000800282 <yield>:
  800282:	b5bd                	j	8000f0 <sys_yield>

0000000000800284 <kill>:
  800284:	bd85                	j	8000f4 <sys_kill>

0000000000800286 <getpid>:
  800286:	bd95                	j	8000fa <sys_getpid>
...
000000000080070a <work>:
  ...
  80075a:	b29ff0ef          	jal	ra,800282 <yield>
  80075e:	b29ff0ef          	jal	ra,800286 <getpid>
  ...
  80076e:	a03ff0ef          	jal	ra,800170 <cprintf>
  ...
  800812:	a75ff0ef          	jal	ra,800286 <getpid>
  800816:	85aa                	mv	a1,a0
  800818:	00000517          	auipc	a0,0x0
  80081c:	5e850513          	addi	a0,a0,1512 # 800e00 <error_string+0xe8>
  800820:	951ff0ef          	jal	ra,800170 <cprintf>
  800824:	4501                	li	a0,0
  800826:	a3fff0ef          	jal	ra,800264 <exit>
...
000000000080082a <main>:
  ...
  80084c:	a2fff0ef          	jal	ra,80027a <fork>
  ...
  800868:	909ff0ef          	jal	ra,800170 <cprintf>
  80086c:	4455                	li	s0,21
  80086e:	a0fff0ef          	jal	ra,80027c <wait>
  ...
  800880:	8f1ff0ef          	jal	ra,800170 <cprintf>

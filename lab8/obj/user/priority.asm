...
0000000000800020 <__panic>:
  ...
  800044:	134000ef          	jal	ra,800178 <cprintf>
  800048:	65a2                	ld	a1,8(sp)
  80004a:	8522                	mv	a0,s0
  80004c:	106000ef          	jal	ra,800152 <vcprintf>
  800050:	00001517          	auipc	a0,0x1
  800054:	8a050513          	addi	a0,a0,-1888 # 8008f0 <main+0x21c>
  800058:	120000ef          	jal	ra,800178 <cprintf>
  80005c:	5559                	li	a0,-10
  80005e:	20e000ef          	jal	ra,80026c <exit>
...
0000000000800062 <__warn>:
  ...
  800086:	0f2000ef          	jal	ra,800178 <cprintf>
  80008a:	65a2                	ld	a1,8(sp)
  80008c:	8522                	mv	a0,s0
  80008e:	0c4000ef          	jal	ra,800152 <vcprintf>
  800092:	00001517          	auipc	a0,0x1
  800096:	85e50513          	addi	a0,a0,-1954 # 8008f0 <main+0x21c>
  80009a:	0de000ef          	jal	ra,800178 <cprintf>
...
0000000000800128 <_start>:
  800128:	0d0000ef          	jal	ra,8001f8 <umain>
  80012c:	a001                	j	80012c <_start+0x4>

000000000080012e <open>:
  80012e:	1582                	slli	a1,a1,0x20
  800130:	9181                	srli	a1,a1,0x20
  800132:	bfe9                	j	80010c <sys_open>

0000000000800134 <close>:
  800134:	b7cd                	j	800116 <sys_close>

0000000000800136 <dup2>:
  800136:	b7e5                	j	80011e <sys_dup>
...
0000000000800138 <cputch>:
  ...
  800140:	fbbff0ef          	jal	ra,8000fa <sys_putc>
...
0000000000800152 <vcprintf>:
  ...
  800164:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <pids+0xffffffffff7f5aa9>
  800168:	ec06                	sd	ra,24(sp)
  80016a:	c602                	sw	zero,12(sp)
  80016c:	1ca000ef          	jal	ra,800336 <vprintfmt>
...
0000000000800178 <cprintf>:
  ...
  80017e:	8e2a                	mv	t3,a0
  800180:	f42e                	sd	a1,40(sp)
  800182:	75dd                	lui	a1,0xffff7
  800184:	f832                	sd	a2,48(sp)
  800186:	fc36                	sd	a3,56(sp)
  800188:	e0ba                	sd	a4,64(sp)
  80018a:	00000517          	auipc	a0,0x0
  80018e:	fae50513          	addi	a0,a0,-82 # 800138 <cputch>
  800192:	0050                	addi	a2,sp,4
  800194:	871a                	mv	a4,t1
  800196:	86f2                	mv	a3,t3
  800198:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <pids+0xffffffffff7f5aa9>
  80019c:	ec06                	sd	ra,24(sp)
  80019e:	e4be                	sd	a5,72(sp)
  8001a0:	e8c2                	sd	a6,80(sp)
  8001a2:	ecc6                	sd	a7,88(sp)
  8001a4:	e41a                	sd	t1,8(sp)
  8001a6:	c202                	sw	zero,4(sp)
  8001a8:	18e000ef          	jal	ra,800336 <vprintfmt>
  8001ac:	60e2                	ld	ra,24(sp)
  8001ae:	4512                	lw	a0,4(sp)
  8001b0:	6125                	addi	sp,sp,96
  8001b2:	8082                	ret

00000000008001b4 <initfd>:
  8001b4:	1101                	addi	sp,sp,-32
  8001b6:	87ae                	mv	a5,a1
  8001b8:	e426                	sd	s1,8(sp)
  8001ba:	85b2                	mv	a1,a2
  8001bc:	84aa                	mv	s1,a0
  8001be:	853e                	mv	a0,a5
  8001c0:	e822                	sd	s0,16(sp)
  8001c2:	ec06                	sd	ra,24(sp)
  8001c4:	f6bff0ef          	jal	ra,80012e <open>
  8001c8:	842a                	mv	s0,a0
  8001ca:	00054463          	bltz	a0,8001d2 <initfd+0x1e>
  8001ce:	00951863          	bne	a0,s1,8001de <initfd+0x2a>
  8001d2:	60e2                	ld	ra,24(sp)
  8001d4:	8522                	mv	a0,s0
  8001d6:	6442                	ld	s0,16(sp)
  8001d8:	64a2                	ld	s1,8(sp)
  8001da:	6105                	addi	sp,sp,32
  8001dc:	8082                	ret
  8001de:	8526                	mv	a0,s1
  8001e0:	f55ff0ef          	jal	ra,800134 <close>
  8001e4:	85a6                	mv	a1,s1
  8001e6:	8522                	mv	a0,s0
  8001e8:	f4fff0ef          	jal	ra,800136 <dup2>
  8001ec:	84aa                	mv	s1,a0
  8001ee:	8522                	mv	a0,s0
  8001f0:	f45ff0ef          	jal	ra,800134 <close>
  8001f4:	8426                	mv	s0,s1
  8001f6:	bff1                	j	8001d2 <initfd+0x1e>

00000000008001f8 <umain>:
  8001f8:	1101                	addi	sp,sp,-32
  8001fa:	e822                	sd	s0,16(sp)
  8001fc:	e426                	sd	s1,8(sp)
  8001fe:	842a                	mv	s0,a0
  800200:	84ae                	mv	s1,a1
  800202:	4601                	li	a2,0
  800204:	00000597          	auipc	a1,0x0
  800208:	6cc58593          	addi	a1,a1,1740 # 8008d0 <main+0x1fc>
  80020c:	4501                	li	a0,0
  80020e:	ec06                	sd	ra,24(sp)
  800210:	fa5ff0ef          	jal	ra,8001b4 <initfd>
  800214:	02054263          	bltz	a0,800238 <umain+0x40>
  800218:	4605                	li	a2,1
  80021a:	00000597          	auipc	a1,0x0
  80021e:	6f658593          	addi	a1,a1,1782 # 800910 <main+0x23c>
  800222:	4505                	li	a0,1
  800224:	f91ff0ef          	jal	ra,8001b4 <initfd>
  800228:	02054563          	bltz	a0,800252 <umain+0x5a>
  80022c:	85a6                	mv	a1,s1
  80022e:	8522                	mv	a0,s0
  800230:	4a4000ef          	jal	ra,8006d4 <main>
  800234:	038000ef          	jal	ra,80026c <exit>
  800238:	86aa                	mv	a3,a0
  80023a:	00000617          	auipc	a2,0x0
  80023e:	69e60613          	addi	a2,a2,1694 # 8008d8 <main+0x204>
  800242:	45e9                	li	a1,26
  800244:	00000517          	auipc	a0,0x0
  800248:	6b450513          	addi	a0,a0,1716 # 8008f8 <main+0x224>
  80024c:	e17ff0ef          	jal	ra,800062 <__warn>
  800250:	b7e1                	j	800218 <umain+0x20>
  800252:	86aa                	mv	a3,a0
  800254:	00000617          	auipc	a2,0x0
  800258:	6c460613          	addi	a2,a2,1732 # 800918 <main+0x244>
  80025c:	45f5                	li	a1,29
  80025e:	00000517          	auipc	a0,0x0
  800262:	69a50513          	addi	a0,a0,1690 # 8008f8 <main+0x224>
  800266:	dfdff0ef          	jal	ra,800062 <__warn>
  80026a:	b7c9                	j	80022c <umain+0x34>

000000000080026c <exit>:
  80026c:	1141                	addi	sp,sp,-16
  80026e:	e406                	sd	ra,8(sp)
  800270:	e6fff0ef          	jal	ra,8000de <sys_exit>
  800274:	00000517          	auipc	a0,0x0
  800278:	6c450513          	addi	a0,a0,1732 # 800938 <main+0x264>
  80027c:	efdff0ef          	jal	ra,800178 <cprintf>
  800280:	a001                	j	800280 <exit+0x14>

0000000000800282 <fork>:
  800282:	b58d                	j	8000e4 <sys_fork>

0000000000800284 <waitpid>:
  800284:	b595                	j	8000e8 <sys_wait>

0000000000800286 <kill>:
  800286:	b5ad                	j	8000f0 <sys_kill>

0000000000800288 <getpid>:
  800288:	b5bd                	j	8000f6 <sys_getpid>

000000000080028a <gettime_msec>:
  80028a:	bdbd                	j	800108 <sys_gettime>

000000000080028c <lab6_set_priority>:
  80028c:	1502                	slli	a0,a0,0x20
  80028e:	9101                	srli	a0,a0,0x20
  800290:	bd85                	j	800100 <sys_lab6_set_priority>
...
00000000008006d4 <main>:
  ...
  80070a:	b83ff0ef          	jal	ra,80028c <lab6_set_priority>
  80070e:	89d6                	mv	s3,s5
  800710:	84ca                	mv	s1,s2
  800712:	4401                	li	s0,0
  800714:	4a15                	li	s4,5
  800716:	0009a023          	sw	zero,0(s3)
  80071a:	b69ff0ef          	jal	ra,800282 <fork>
  ...
  800740:	a39ff0ef          	jal	ra,800178 <cprintf>
  ...
  8007c6:	9b3ff0ef          	jal	ra,800178 <cprintf>
  8007ca:	fd349fe3          	bne	s1,s3,8007a8 <main+0xd4>
  8007ce:	00000517          	auipc	a0,0x0
  8007d2:	12250513          	addi	a0,a0,290 # 8008f0 <main+0x21c>
  8007d6:	9a3ff0ef          	jal	ra,800178 <cprintf>
  ...
  8007fe:	a8fff0ef          	jal	ra,80028c <lab6_set_priority>
  ...
  800834:	a57ff0ef          	jal	ra,80028a <gettime_msec>
  800838:	0005091b          	sext.w	s2,a0
  80083c:	fd29d9e3          	bge	s3,s2,80080e <main+0x13a>
  800840:	a49ff0ef          	jal	ra,800288 <getpid>
  ...
  800852:	927ff0ef          	jal	ra,800178 <cprintf>
  800856:	4008                	lw	a0,0(s0)
  800858:	a15ff0ef          	jal	ra,80026c <exit>
  ...
  80086c:	a1bff0ef          	jal	ra,800286 <kill>

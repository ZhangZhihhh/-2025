...
0000000000800020 <__panic>:
  ...
  800044:	11e000ef          	jal	ra,800162 <cprintf>
  800048:	65a2                	ld	a1,8(sp)
  80004a:	8522                	mv	a0,s0
  80004c:	0f0000ef          	jal	ra,80013c <vcprintf>
  800050:	00000517          	auipc	a0,0x0
  800054:	76050513          	addi	a0,a0,1888 # 8007b0 <main+0x10c>
  800058:	10a000ef          	jal	ra,800162 <cprintf>
  80005c:	5559                	li	a0,-10
  80005e:	1f8000ef          	jal	ra,800256 <exit>
...
0000000000800062 <__warn>:
  ...
  800086:	0dc000ef          	jal	ra,800162 <cprintf>
  80008a:	65a2                	ld	a1,8(sp)
  80008c:	8522                	mv	a0,s0
  80008e:	0ae000ef          	jal	ra,80013c <vcprintf>
  800092:	00000517          	auipc	a0,0x0
  800096:	71e50513          	addi	a0,a0,1822 # 8007b0 <main+0x10c>
  80009a:	0c8000ef          	jal	ra,800162 <cprintf>
...
0000000000800112 <_start>:
  800112:	0d0000ef          	jal	ra,8001e2 <umain>
  800116:	a001                	j	800116 <_start+0x4>

0000000000800118 <open>:
  800118:	1582                	slli	a1,a1,0x20
  80011a:	9181                	srli	a1,a1,0x20
  80011c:	bfe9                	j	8000f6 <sys_open>

000000000080011e <close>:
  80011e:	b7cd                	j	800100 <sys_close>

0000000000800120 <dup2>:
  800120:	b7e5                	j	800108 <sys_dup>
...
0000000000800122 <cputch>:
  ...
  80012a:	fc7ff0ef          	jal	ra,8000f0 <sys_putc>
...
000000000080013c <vcprintf>:
  ...
  80014e:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f5f61>
...
0000000000800162 <cprintf>:
  ...
  800178:	fae50513          	addi	a0,a0,-82 # 800122 <cputch>
  80017c:	0050                	addi	a2,sp,4
  80017e:	871a                	mv	a4,t1
  800180:	86f2                	mv	a3,t3
  800182:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f5f61>
  ...
  800192:	174000ef          	jal	ra,800306 <vprintfmt>
  800196:	60e2                	ld	ra,24(sp)
  800198:	4512                	lw	a0,4(sp)
  80019a:	6125                	addi	sp,sp,96
  80019c:	8082                	ret

000000000080019e <initfd>:
  80019e:	1101                	addi	sp,sp,-32
  8001a0:	87ae                	mv	a5,a1
  8001a2:	e426                	sd	s1,8(sp)
  8001a4:	85b2                	mv	a1,a2
  8001a6:	84aa                	mv	s1,a0
  8001a8:	853e                	mv	a0,a5
  8001aa:	e822                	sd	s0,16(sp)
  8001ac:	ec06                	sd	ra,24(sp)
  8001ae:	f6bff0ef          	jal	ra,800118 <open>
  8001b2:	842a                	mv	s0,a0
  8001b4:	00054463          	bltz	a0,8001bc <initfd+0x1e>
  8001b8:	00951863          	bne	a0,s1,8001c8 <initfd+0x2a>
  8001bc:	60e2                	ld	ra,24(sp)
  8001be:	8522                	mv	a0,s0
  8001c0:	6442                	ld	s0,16(sp)
  8001c2:	64a2                	ld	s1,8(sp)
  8001c4:	6105                	addi	sp,sp,32
  8001c6:	8082                	ret
  8001c8:	8526                	mv	a0,s1
  8001ca:	f55ff0ef          	jal	ra,80011e <close>
  8001ce:	85a6                	mv	a1,s1
  8001d0:	8522                	mv	a0,s0
  8001d2:	f4fff0ef          	jal	ra,800120 <dup2>
  8001d6:	84aa                	mv	s1,a0
  8001d8:	8522                	mv	a0,s0
  8001da:	f45ff0ef          	jal	ra,80011e <close>
  8001de:	8426                	mv	s0,s1
  8001e0:	bff1                	j	8001bc <initfd+0x1e>

00000000008001e2 <umain>:
  ...
  8001ec:	4601                	li	a2,0
  8001ee:	00000597          	auipc	a1,0x0
  8001f2:	5a258593          	addi	a1,a1,1442 # 800790 <main+0xec>
  8001f6:	4501                	li	a0,0
  8001f8:	ec06                	sd	ra,24(sp)
  8001fa:	fa5ff0ef          	jal	ra,80019e <initfd>
  8001fe:	02054263          	bltz	a0,800222 <umain+0x40>
  800202:	4605                	li	a2,1
  800204:	00000597          	auipc	a1,0x0
  800208:	5cc58593          	addi	a1,a1,1484 # 8007d0 <main+0x12c>
  80020c:	4505                	li	a0,1
  80020e:	f91ff0ef          	jal	ra,80019e <initfd>
  800212:	02054563          	bltz	a0,80023c <umain+0x5a>
  800216:	85a6                	mv	a1,s1
  800218:	8522                	mv	a0,s0
  80021a:	48a000ef          	jal	ra,8006a4 <main>
  80021e:	038000ef          	jal	ra,800256 <exit>
  800222:	86aa                	mv	a3,a0
  800224:	00000617          	auipc	a2,0x0
  800228:	57460613          	addi	a2,a2,1396 # 800798 <main+0xf4>
  80022c:	45e9                	li	a1,26
  80022e:	00000517          	auipc	a0,0x0
  800232:	58a50513          	addi	a0,a0,1418 # 8007b8 <main+0x114>
  800236:	e2dff0ef          	jal	ra,800062 <__warn>
  80023a:	b7e1                	j	800202 <umain+0x20>
  80023c:	86aa                	mv	a3,a0
  80023e:	00000617          	auipc	a2,0x0
  800242:	59a60613          	addi	a2,a2,1434 # 8007d8 <main+0x134>
  800246:	45f5                	li	a1,29
  800248:	00000517          	auipc	a0,0x0
  80024c:	57050513          	addi	a0,a0,1392 # 8007b8 <main+0x114>
  800250:	e13ff0ef          	jal	ra,800062 <__warn>
  800254:	b7c9                	j	800216 <umain+0x34>

0000000000800256 <exit>:
  800256:	1141                	addi	sp,sp,-16
  800258:	e406                	sd	ra,8(sp)
  80025a:	e85ff0ef          	jal	ra,8000de <sys_exit>
  80025e:	00000517          	auipc	a0,0x0
  800262:	59a50513          	addi	a0,a0,1434 # 8007f8 <main+0x154>
  800266:	efdff0ef          	jal	ra,800162 <cprintf>
  80026a:	a001                	j	80026a <exit+0x14>

000000000080026c <fork>:
  80026c:	bda5                	j	8000e4 <sys_fork>

000000000080026e <wait>:
  80026e:	4581                	li	a1,0
  800270:	4501                	li	a0,0
  800272:	bd9d                	j	8000e8 <sys_wait>
...
00000000008006a4 <main>:
  ...
  8006b2:	bbbff0ef          	jal	ra,80026c <fork>
  ...
  8006de:	a85ff0ef          	jal	ra,800162 <cprintf>
  ...
  8006f8:	a6bff0ef          	jal	ra,800162 <cprintf>
  8006fc:	4501                	li	a0,0
  8006fe:	b59ff0ef          	jal	ra,800256 <exit>

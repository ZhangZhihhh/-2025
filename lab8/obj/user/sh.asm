...
0000000000800020 <__panic>:
  ...
  800054:	d4850513          	addi	a0,a0,-696 # 800d98 <main+0x12a>
...
0000000000800062 <__warn>:
  ...
  800096:	d0650513          	addi	a0,a0,-762 # 800d98 <main+0x12a>
...
000000000080018c <vcprintf>:
  ...
  80019e:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <buffer.1192+0xffffffffff7f29d1>
...
00000000008002a8 <umain>:
  ...
  8002b8:	ac458593          	addi	a1,a1,-1340 # 800d78 <main+0x10a>
  8002bc:	4501                	li	a0,0
...
000000000080031c <exit>:
  ...
  800328:	abc50513          	addi	a0,a0,-1348 # 800de0 <main+0x172>
...
0000000000800916 <readline>:
  ...
  800936:	4505                	li	a0,1
  800938:	8f7ff0ef          	jal	ra,80022e <fprintf>
  ...
  80095a:	4501                	li	a0,0
  80095c:	fe6ff0ef          	jal	ra,800142 <read>
  ...
  80097e:	4505                	li	a0,1
  800980:	8afff0ef          	jal	ra,80022e <fprintf>
  ...
  80099a:	fa8ff0ef          	jal	ra,800142 <read>
  ...
  8009ca:	4505                	li	a0,1
  8009cc:	863ff0ef          	jal	ra,80022e <fprintf>
  ...
  8009e6:	4505                	li	a0,1
  8009e8:	847ff0ef          	jal	ra,80022e <fprintf>
...
0000000000800a0c <reopen>:
  ...
  800a1c:	f24ff0ef          	jal	ra,800140 <close>
  800a20:	8522                	mv	a0,s0
  800a22:	85ca                	mv	a1,s2
  800a24:	f16ff0ef          	jal	ra,80013a <open>
  ...
  800a54:	ef2ff0ef          	jal	ra,800146 <dup2>
  800a58:	84aa                	mv	s1,a0
  800a5a:	8522                	mv	a0,s0
  800a5c:	ee4ff0ef          	jal	ra,800140 <close>
...
0000000000800a64 <testfile>:
  ...
  800a6a:	ed0ff0ef          	jal	ra,80013a <open>
  800a6e:	87aa                	mv	a5,a0
  800a70:	00054563          	bltz	a0,800a7a <testfile+0x16>
  800a74:	eccff0ef          	jal	ra,800140 <close>
  800a78:	4781                	li	a5,0
...
0000000000800a82 <runcmd>:
  ...
  800af4:	83fff0ef          	jal	ra,800332 <fork>
  800af8:	87aa                	mv	a5,a0
  800afa:	10051863          	bnez	a0,800c0a <runcmd+0x188>
  800afe:	e42ff0ef          	jal	ra,800140 <close>
  800b02:	4581                	li	a1,0
  800b04:	4501                	li	a0,0
  800b06:	e40ff0ef          	jal	ra,800146 <dup2>
  800b0a:	84aa                	mv	s1,a0
  800b0c:	04054c63          	bltz	a0,800b64 <runcmd+0xe2>
  800b10:	4501                	li	a0,0
  800b12:	e2eff0ef          	jal	ra,800140 <close>
  800b16:	4501                	li	a0,0
  800b18:	e28ff0ef          	jal	ra,800140 <close>
  ...
  800b5c:	4505                	li	a0,1
  800b5e:	ed0ff0ef          	jal	ra,80022e <fprintf>
  800b62:	54fd                	li	s1,-1
  ...
  800c02:	f34ff0ef          	jal	ra,800336 <__exec>
  800c06:	84aa                	mv	s1,a0
  800c08:	bfb1                	j	800b64 <runcmd+0xe2>
  800c0a:	00054c63          	bltz	a0,800c22 <runcmd+0x1a0>
  800c0e:	4505                	li	a0,1
  800c10:	d30ff0ef          	jal	ra,800140 <close>
  800c14:	4585                	li	a1,1
  800c16:	4501                	li	a0,0
  800c18:	d2eff0ef          	jal	ra,800146 <dup2>
  ...
  800c2e:	4505                	li	a0,1
  800c30:	dfeff0ef          	jal	ra,80022e <fprintf>
  800c34:	54fd                	li	s1,-1
  800c36:	b73d                	j	800b64 <runcmd+0xe2>
  800c38:	4501                	li	a0,0
  800c3a:	d06ff0ef          	jal	ra,800140 <close>
  800c3e:	4501                	li	a0,0
  800c40:	d00ff0ef          	jal	ra,800140 <close>
...
0000000000800c6e <main>:
  ...
  800c84:	d6aff0ef          	jal	ra,8001ee <cputs>
  800c88:	4789                	li	a5,2
  ...
  800cde:	4505                	li	a0,1
  800ce0:	d4eff0ef          	jal	ra,80022e <fprintf>
  ...
  800d00:	4505                	li	a0,1
  800d02:	d2cff0ef          	jal	ra,80022e <fprintf>
  800d06:	557d                	li	a0,-1
  ...
  800d32:	deaff0ef          	jal	ra,80031c <exit>

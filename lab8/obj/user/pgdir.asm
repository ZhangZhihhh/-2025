...
0000000000800020 <__warn>:
  ...
  800034:	67850513          	addi	a0,a0,1656 # 8006a8 <main+0x4e>
  ...
  800054:	69850513          	addi	a0,a0,1688 # 8006e8 <main+0x8e>
...
00000000008000ac <sys_pgdir>:
  8000ac:	457d                	li	a0,31
...
00000000008000cc <_start>:
  8000cc:	0d0000ef          	jal	ra,80019c <umain>
  8000d0:	a001                	j	8000d0 <_start+0x4>

00000000008000d2 <open>:
  8000d2:	1582                	slli	a1,a1,0x20
  8000d4:	9181                	srli	a1,a1,0x20
  8000d6:	bfe9                	j	8000b0 <sys_open>

00000000008000d8 <close>:
  8000d8:	b7cd                	j	8000ba <sys_close>

00000000008000da <dup2>:
  8000da:	b7e5                	j	8000c2 <sys_dup>
...
00000000008000dc <cputch>:
  ...
  8000e4:	fc3ff0ef          	jal	ra,8000a6 <sys_putc>
...
00000000008000f6 <vcprintf>:
  ...
  8000f8:	872e                	mv	a4,a1
  8000fa:	75dd                	lui	a1,0xffff7
  8000fc:	86aa                	mv	a3,a0
  8000fe:	0070                	addi	a2,sp,12
  800100:	00000517          	auipc	a0,0x0
  800104:	fdc50513          	addi	a0,a0,-36 # 8000dc <cputch>
  800108:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6029>
  80010c:	ec06                	sd	ra,24(sp)
  80010e:	c602                	sw	zero,12(sp)
  800110:	1ac000ef          	jal	ra,8002bc <vprintfmt>
...
000000000080011c <cprintf>:
  ...
  800132:	fae50513          	addi	a0,a0,-82 # 8000dc <cputch>
  800136:	0050                	addi	a2,sp,4
  800138:	871a                	mv	a4,t1
  80013a:	86f2                	mv	a3,t3
  80013c:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6029>
  ...
  80014c:	170000ef          	jal	ra,8002bc <vprintfmt>
  800150:	60e2                	ld	ra,24(sp)
  800152:	4512                	lw	a0,4(sp)
  800154:	6125                	addi	sp,sp,96
  800156:	8082                	ret

0000000000800158 <initfd>:
  800158:	1101                	addi	sp,sp,-32
  80015a:	87ae                	mv	a5,a1
  80015c:	e426                	sd	s1,8(sp)
  80015e:	85b2                	mv	a1,a2
  800160:	84aa                	mv	s1,a0
  800162:	853e                	mv	a0,a5
  800164:	e822                	sd	s0,16(sp)
  800166:	ec06                	sd	ra,24(sp)
  800168:	f6bff0ef          	jal	ra,8000d2 <open>
  80016c:	842a                	mv	s0,a0
  80016e:	00054463          	bltz	a0,800176 <initfd+0x1e>
  800172:	00951863          	bne	a0,s1,800182 <initfd+0x2a>
  800176:	60e2                	ld	ra,24(sp)
  800178:	8522                	mv	a0,s0
  80017a:	6442                	ld	s0,16(sp)
  80017c:	64a2                	ld	s1,8(sp)
  80017e:	6105                	addi	sp,sp,32
  800180:	8082                	ret
  800182:	8526                	mv	a0,s1
  800184:	f55ff0ef          	jal	ra,8000d8 <close>
  800188:	85a6                	mv	a1,s1
  80018a:	8522                	mv	a0,s0
  80018c:	f4fff0ef          	jal	ra,8000da <dup2>
  800190:	84aa                	mv	s1,a0
  800192:	8522                	mv	a0,s0
  800194:	f45ff0ef          	jal	ra,8000d8 <close>
  800198:	8426                	mv	s0,s1
  80019a:	bff1                	j	800176 <initfd+0x1e>

000000000080019c <umain>:
  80019c:	1101                	addi	sp,sp,-32
  80019e:	e822                	sd	s0,16(sp)
  8001a0:	e426                	sd	s1,8(sp)
  8001a2:	842a                	mv	s0,a0
  8001a4:	84ae                	mv	s1,a1
  8001a6:	4601                	li	a2,0
  8001a8:	00000597          	auipc	a1,0x0
  8001ac:	52058593          	addi	a1,a1,1312 # 8006c8 <main+0x6e>
  8001b0:	4501                	li	a0,0
  8001b2:	ec06                	sd	ra,24(sp)
  8001b4:	fa5ff0ef          	jal	ra,800158 <initfd>
  8001b8:	02054263          	bltz	a0,8001dc <umain+0x40>
  8001bc:	4605                	li	a2,1
  8001be:	00000597          	auipc	a1,0x0
  8001c2:	54a58593          	addi	a1,a1,1354 # 800708 <main+0xae>
  8001c6:	4505                	li	a0,1
  8001c8:	f91ff0ef          	jal	ra,800158 <initfd>
  8001cc:	02054563          	bltz	a0,8001f6 <umain+0x5a>
  8001d0:	85a6                	mv	a1,s1
  8001d2:	8522                	mv	a0,s0
  8001d4:	486000ef          	jal	ra,80065a <main>
  8001d8:	038000ef          	jal	ra,800210 <exit>
  8001dc:	86aa                	mv	a3,a0
  8001de:	00000617          	auipc	a2,0x0
  8001e2:	4f260613          	addi	a2,a2,1266 # 8006d0 <main+0x76>
  8001e6:	45e9                	li	a1,26
  8001e8:	00000517          	auipc	a0,0x0
  8001ec:	50850513          	addi	a0,a0,1288 # 8006f0 <main+0x96>
  8001f0:	e31ff0ef          	jal	ra,800020 <__warn>
  8001f4:	b7e1                	j	8001bc <umain+0x20>
  8001f6:	86aa                	mv	a3,a0
  8001f8:	00000617          	auipc	a2,0x0
  8001fc:	51860613          	addi	a2,a2,1304 # 800710 <main+0xb6>
  800200:	45f5                	li	a1,29
  800202:	00000517          	auipc	a0,0x0
  800206:	4ee50513          	addi	a0,a0,1262 # 8006f0 <main+0x96>
  80020a:	e17ff0ef          	jal	ra,800020 <__warn>
  80020e:	b7c9                	j	8001d0 <umain+0x34>

0000000000800210 <exit>:
  800210:	1141                	addi	sp,sp,-16
  800212:	e406                	sd	ra,8(sp)
  800214:	e89ff0ef          	jal	ra,80009c <sys_exit>
  800218:	00000517          	auipc	a0,0x0
  80021c:	51850513          	addi	a0,a0,1304 # 800730 <main+0xd6>
  800220:	efdff0ef          	jal	ra,80011c <cprintf>
  800224:	a001                	j	800224 <exit+0x14>

0000000000800226 <getpid>:
  800226:	bdb5                	j	8000a2 <sys_getpid>

0000000000800228 <print_pgdir>:
  800228:	b551                	j	8000ac <sys_pgdir>
...
0000000000800246 <printnum>:
  ...
  80028e:	4be78793          	addi	a5,a5,1214 # 800748 <main+0xee>
...
00000000008002bc <vprintfmt>:
  ...
  8002ec:	494b0b13          	addi	s6,s6,1172 # 80077c <main+0x122>
  ...
  80054e:	56668693          	addi	a3,a3,1382 # 800ab0 <error_string>
  ...
  80055e:	21e68693          	addi	a3,a3,542 # 800778 <main+0x11e>
  ...
  800572:	1fa68693          	addi	a3,a3,506 # 800768 <main+0x10e>
  ...
  800586:	1de40413          	addi	s0,s0,478 # 800760 <main+0x106>
  ...
  800614:	15040413          	addi	s0,s0,336 # 800760 <main+0x106>
  ...
  80062a:	13ba8a93          	addi	s5,s5,315 # 800761 <main+0x107>
